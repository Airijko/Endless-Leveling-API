...
/**
 * Shared First Strike VFX/SFX payload used by augment and archetype passive triggers.
 */
public final class FirstStrikeTriggerEffects {
    ...
    private FirstStrikeTriggerEffects() {
    }
