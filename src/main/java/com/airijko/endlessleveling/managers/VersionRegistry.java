...
public final class VersionRegistry {
    ...
    public static final int CONFIG_YML_VERSION = 45;
    public static final int LEVELING_YML_VERSION = 49;
    ...
    public static final int BUILTIN_CLASSES_VERSION = 44;
    public static final int BUILTIN_RACES_VERSION = 44;
